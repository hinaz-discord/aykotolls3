...
this.connection = StateManager.connection;
    ...
    const isWbWlRes = isWlFetched[0].webhookCreate;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
...
const wbUp = async function checkWbWlOn(guildID) {
    ...
    const isWbWlRes = isWlFetched[0].webhookUpdate;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
...
const wbDel = async function checkWbWlOn(guildID) {
    ...
    const isWbWlRes = isWlFetched[0].webhookDelete;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
...
const rlCr = async function checkWbWlOn(guildID) {
    ...
    const isWbWlRes = isWlFetched[0].roleCreate;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
...
const rlUp = async function checkWbWlOn(guildID) {
    ...
    const isWbWlRes = isWlFetched[0].roleUpdate;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
...
const chCr = async function checkWbWlOn(guildID) {
    ...
    const isWbWlRes = isWlFetched[0].channelCreate;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
...
const chUp = async function checkWbWlOn(guildID) {
    ...
    const isWbWlRes = isWlFetched[0].channelUpdate;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
...
const chDel = async function checkWbWlOn(guildID) {
    ...
    const isWbWlRes = isWlFetched[0].channelDelete;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
...
const spam = async function checkWbWlOn(guildID) {
    ...
    const isWbWlRes = isWlFetched[0].spam;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
...
const ban = async function checkWbWlOn(guildID) {
    ...
    const isWbWlRes = isWlFetched[0].ban;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
...
const bot = async function checkWbWlOn(guildID) {
    ...
    const isWbWlRes = isWlFetched[0].bot;
    var isWlOn = false
    if (isWbWlRes == "1") {
        isWlOn = true;
    }
